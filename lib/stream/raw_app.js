...
function registerLockedMouseEvents(playerElement) {
    ...
    playerElement.onclick = function() {
        ...
        if (webRtcPlayerObj && webRtcPlayerObj.video)
		{
			console.log("unmuting video. muted: " + webRtcPlayerObj.video.muted + ", volume: " + webRtcPlayerObj.video.volume);
			webRtcPlayerObj.video.muted = false;
			webRtcPlayerObj.video.volume = 1;
		}
    };
